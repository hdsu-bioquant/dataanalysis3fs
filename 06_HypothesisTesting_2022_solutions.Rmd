...
There are two alternative but equivalenet ways to do so.
Either:
...
The hypotheses can be formulated as: \> H0: the expectation value of the random variable "Weight of male patients" is **equal or greater** 180.
...
The hypotheses can be formulated as: \> H0: the expectation value of the random variable "Weight of male patients" is **equal** to the expectation value of the random variable "Weight of female patients".
...
> H0: the mean chol value of the Buckingham groups is not significantly different from the mean chol value of the Louisa group.
> H1: the mean chol value of the Buckingham groups is significantly different from the mean chol value of the Louisa group.

---
title: "Exercise Sheet 06: hypothesis testing - solutions"
...
\> H0: the mean height value for the women group is **not significantly smaller** than the mean height for the men group.\
\> H1: the mean heigth value for the women group is **significantly smaller** than the mean height for the men group.
...
\> H0: the expectation value of the random variable "age of male patients" is **greater or equal** to 50.\
\> H1: the expectation value of the random variable "age of male patients" is **less** than 50.
...
\> H0: the mean chol value of the Buckingham group is **not significantly different** from the mean chol value of the Louisa group.\
\> H1: the mean chol value of the Buckingham group is **significantly different** from the mean chol value of the Louisa group.

...
Add two empty spaces at the end of a line to go to the next line.
Compare:  
Line 1
Line 2  
with  
...
In the Markdown file, you can see the results of the command directly bellow the "r chunk".
Importantly, you can name your chunks.  

...
-   **Mode ≈ 5 minutes** (most common waiting time)
...
# ============================================
# CHANGE THIS VALUE TO EXPERIMENT!
sample_size <- 50  # Try: 2, 5, 10, 30, 50, 200
# ============================================
...
-   **Green (n=50):** Clearly narrowing around μ = 6
...
1.  **Larger sample → narrower CI:** More data gives more precise estimates
...
> 1 - Why do some intervals miss the true λ even though we're using a "95% confidence" method?\
